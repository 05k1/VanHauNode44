...
-- Insert data cho table restaurant
...
-- Insert data cho table rate_res
...
-- Insert data cho table like_res
...
-- Insert data cho table sub_food 
INSERT INTO sub_food (sub_name, sub_price, food_id) VALUES
('Extra Cheese', 2.5, 1), 
('Fried Peanuts', 1.99, 2), 
('Extra Wasabi', 0.5, 3), 
('Garlic Naan', 3.5, 5), 
('Chocolate Filling', 1.5, 6),
('Extra Olives', 1.0, 7), 
('Shrimp Add-on', 3.0, 8), 
('Extra Lime', 0.5, 9), 
('Kimchi', 2.0, 10),
...
('Pistachios', 1.5, 16),
('Couscous', 2.0, 17),
('Extra Injera', 1.99, 18),
('Rice & Peas', 2.0, 19),
('Potato Salad', 1.99, 20);

-- Tìm 5 người đã like nhà hàng nhiều nhất
SELECT u.full_name, COUNT(*) AS total_likes
FROM like_res l
...
SELECT r.res_name, COUNT(*) AS total_likes
FROM like_res l
...
SELECT u.full_name, COUNT(*) AS total_orders
FROM orders o
...
WHERE o.order_id IS NULL AND l.user_id IS NULL AND r.user_id IS NULL;